...
<body style="overflow-x: hidden">
    ...
    <main>	
        ...
        <div id="page" style="z-index: 2;">
			<div class="box">
				<h2>Sign up</h2>
				<p>Welcome to our membership</p>
				
				<form action="/member/add.do" method="post" >
				
					<div class="inputBox">
                     	<input type="text" name="memName" required onkeyup="this.setAttribute('value', this.value);" value=""
                     	style="font-size:12pt; color:white; font-weight:bold;">
                     	<label>Name</label>
                  	</div>
                  	<div class="inputBox">
                    	<input type="text" name="memId" required onkeyup="this.setAttribute('value', this.value);"  value=""
                    	style="font-size:12pt; color:white; font-weight:bold;">
                    	<label>Username</label>
                  	</div>
                  	<div class="inputBox">
                     	<input type="text" name="memPass" required onkeyup="this.setAttribute('value', this.value);" value=""
                     	style="font-size:12pt; color:white; font-weight:bold;">
