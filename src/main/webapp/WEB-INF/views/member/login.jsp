        ...
        <div id="page" style="z-index: 2;">
			<div class="box">
				...
				<form action="/member/login.do" method="post" >
                  	...
                  	<div class="inputBox">
                     	<input type="password" name="memPass" required onkeyup="this.setAttribute('value', this.value);" value=""
                     	style="font-size:12pt; color:white; font-weight:bold;">
                     	<label>Passward</label>
                  	</div>
                  <input type="submit" name="sign-in" value="Sign In">
                  <input type="button" name="sign-up" value="Sign Up" onClick="location.href='/member/add.do'">
